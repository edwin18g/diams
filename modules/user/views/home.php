        ...
        <div class="sigma_banner-text">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-6">
                <h1 class="title">OEPN HEARTS OPEN SOULS CHURCH</h1>
                <p class="blockquote mb-0 bg-transparent"> We are a church that belives in Jesus christ and the followers and We are a church that belives in Jesus christ. This is where you should start </p>
      ...
      <div class="light-bg sigma_banner-slider-inner bg-cover bg-center bg-norepeat" style="background-image: url('assets/img/banner/5.jpg');">
        <div class="sigma_banner-text">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-6">
                <h1 class="title">WE ARE A CHURCH THAT BELIVE IN JESUS</h1>
                <p class="blockquote mb-0 bg-transparent"> We are a church that belives in Jesus christ and the followers and We are a church that belives in Jesus christ. This is where you should start </p>
                <div class="section-button d-flex align-items-center">
                  <a href="contact-us.html" class="sigma_btn-custom">Join Today <i class="far fa-arrow-right"></i> </a>
                  <a href="services.html" class="ms-3 sigma_btn-custom white">View Services <i class="far fa-arrow-right"></i> </a>
        ...
        <div class="col-lg-6 mb-lg-30">
          <div class="img-group">
            <div class="img-group-inner">
              <img src="/themes/frontend/assets/img/about-group1/1.jpg" alt="about">
              <span></span>
              <span></span>
            </div>
            <img src="/themes/frontend/assets/img/about-group1/2.jpg" alt="about">
            <img src="/themes/frontend/assets/img/about-group1/3.jpg" alt="about">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="me-lg-30">
            <div class="section-title mb-0 text-start">
              <p class="subtitle">we have 24+ years of experience</p>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <a href="services.html" class="sigma_service style-1 primary-bg">
            <div class="sigma_service-thumb">
              <i class="text-white flaticon-church-2"></i>
            </div>
            <div class="sigma_service-body">
              <h5 class="text-white">About Church</h5>
        ...
        <div class="col-lg-4 col-md-6 mt-negative-sm">
          <a href="services.html" class="sigma_service style-1 secondary-bg">
            <div class="sigma_service-thumb">
              <i class="custom-primary flaticon-sermon"></i>
            </div>
            <div class="sigma_service-body">
              <h5 class="text-white">Our Pastor</h5>
              <p class="text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod </p>
            </div>
        ...
        <div class="col-lg-4 col-md-6 mt-negative-sm">
          <a href="services.html" class="sigma_service style-1 bg-white">
            <div class="sigma_service-thumb">
      ...
      <div class="text-end">
        <a href="services.html" class="btn-link text-white"> Get Started Now <i class="custom-primary far fa-arrow-right"></i> </a>
      </div>
      ...
      <div class="row align-items-center position-relative">
        <div class="col-md-6">
          <div class="sigma_cta secondary-bg">
            <img class="d-none d-lg-block" src="/themes/frontend/assets/img/cta/1.png" alt="cta">
        ...
        <div class="col-md-6">
          <div class="sigma_cta primary-bg">
            ...
            <img class="d-none d-lg-block" src="/themes/frontend/assets/img/cta/2.png" alt="cta">
          </div>
        </div>
      </div>
  ...
  <div class="section pt-0">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-4">
          <img src="/themes/frontend/assets/img/progress-bar/1.jpg" alt="img">
        </div>
        ...
        <div class="col-lg-4 z-index-3">
          <img src="/themes/frontend/assets/img/progress-bar/2.jpg" alt="img">
        </div>
        ...
        <div class="col-lg-6 mb-lg-30">
          ...
          <div class="basic-dot-slider light-dots">
            <div class="slide-item">
              <p class="mb-0">Nulla porttitor accumsan tincidunt. Vivamus suscipit tortor eget felis porttitor volutpat. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet
          ...
          <div class="me-lg-30">
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6">
                <div class="sigma_volunteers volunteers-5">
                  <div class="sigma_volunteers-thumb">
                    <img src="/themes/frontend/assets/img/volunteers/1.jpg" alt="volunteers">
                    <ul class="sigma_sm">
              ...
              <div class="col-lg-6 col-md-6">
                <div class="sigma_volunteers volunteers-5">
                  <div class="sigma_volunteers-thumb">
                    <img src="/themes/frontend/assets/img/volunteers/2.jpg" alt="volunteers">
                    <ul class="sigma_sm">
                      <li> <a href="#" class="trigger-volunteers-socials"> <i class="fal fa-plus"></i> </a> </li>
                      <li> <a href="#"> <i class="fab fa-facebook-f"></i> </a> </li>
                      <li> <a href="#"> <i class="fab fa-twitter"></i> </a> </li>
                  ...
                  <div class="sigma_volunteers-body">
                    <div class="sigma_volunteers-info">
                      <p>Church Memember</p>
                      <h5>
                        <a href="volunteer-detail.html">Issac D. Thomas</a>
                      </h5>
                    </div>
                  </div>
                </div>
  ...
  <div class="section section-padding">
    <div class="container">
      ...
      <div class="text-center filter-items left">
        ...
        <h5 class="portfolio-trigger" data-filter=".strategy">Women</h5>
        <h5 class="portfolio-trigger" data-filter=".relations">Church</h5>
      </div>

      <div class="portfolio-filter row">
        <div class="col-lg-4 coaching">
          <div class="sigma_portfolio-item style-2">
            <img src="/themes/frontend/assets/img/ministries/style-2/1.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="ministry-details.html"> Bakixer Browni Church Accident </a> </h5>
              </div>
              <a href="ministry-details.html"><i class="far fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 strategy">
          <div class="sigma_portfolio-item style-2">
            <img src="/themes/frontend/assets/img/ministries/style-2/2.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
        ...
        <div class="col-lg-4 coaching strategy">
          <div class="sigma_portfolio-item style-2">
            <img src="/themes/frontend/assets/img/ministries/style-2/3.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="ministry-details.html"> Sermons Ministry </a> </h5>
              </div>
              <a href="ministry-details.html"><i class="far fa-arrow-right"></i></a>
            </div>
          </div>
        ...
        <div class="col-lg-4 relations coaching">
          <div class="sigma_portfolio-item style-2">
            <img src="/themes/frontend/assets/img/ministries/style-2/4.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
                <h5> <a href="ministry-details.html"> Women Ministry </a> </h5>
              </div>
              <a href="ministry-details.html"><i class="far fa-arrow-right"></i></a>
            </div>
          </div>
        ...
        <div class="col-lg-4 stakeholder">
          <div class="sigma_portfolio-item style-2">
            <img src="/themes/frontend/assets/img/ministries/style-2/5.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
        ...
        <div class="col-lg-4 stakeholder">
          <div class="sigma_portfolio-item style-2">
            <img src="/themes/frontend/assets/img/ministries/style-2/6.jpg" alt="portfolio">
            <div class="sigma_portfolio-item-content">
              <div class="sigma_portfolio-item-content-inner">
        ...
        <div class="sigma_testimonial-slider">
          ...
          <div class="sigma_testimonial-inner">
            <div class="sigma_testimonial-thumb">
              <img src="/themes/frontend/assets/img/testimonials/1.jpg" alt="testimonial">
            </div>
            <div>
          ...
          <div class="sigma_testimonial-inner">
            <div class="sigma_testimonial-thumb">
              <img src="/themes/frontend/assets/img/testimonials/2.jpg" alt="testimonial">
            </div>
            <div>
              <div class="sigma_testimonial-body">
                <div class="sigma_rating-wrapper">
          ...
          <div class="sigma_testimonial-inner">
            <div class="sigma_testimonial-thumb">
              <img src="/themes/frontend/assets/img/testimonials/3.jpg" alt="testimonial">
            </div>
            <div>
              <div class="sigma_testimonial-body">
                <div class="sigma_rating-wrapper">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="sigma_client">
                <img src="/themes/frontend/assets/img/clients/1.png" alt="client">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="sigma_client">
                <img src="/themes/frontend/assets/img/clients/2.png" alt="client">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="sigma_client">
                <img src="/themes/frontend/assets/img/clients/3.png" alt="client">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="sigma_client">
                <img src="/themes/frontend/assets/img/clients/4.png" alt="client">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="sigma_client">
                <img src="/themes/frontend/assets/img/clients/5.png" alt="client">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="sigma_client">
                <img src="/themes/frontend/assets/img/clients/6.png" alt="client">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
          ...
          <article class="sigma_post">
            <div class="sigma_post-thumb">
              <a href="blog-details.html">
                <img src="/themes/frontend/assets/img/blog/2.jpg" alt="post">
              </a>
            </div>
            <div class="sigma_post-body">
              <div class="sigma_post-meta">
                ...
                <a href="blog-details.html" class="sigma_post-date"> <i class="far fa-calendar"></i> May 20, 2024</a>
              </div>
              <h5> <a href="blog-details.html">Church companies are being so transparent with their work</a> </h5>
              <div class="sigma_post-single-author">
                <img src="/themes/frontend/assets/img/people/1.jpg" alt="author">
        ...
        <div class="col-lg-4 col-md-6">
          <article class="sigma_post">
            <div class="sigma_post-thumb">
              <a href="blog-details.html">
                <img src="/themes/frontend/assets/img/blog/1.jpg" alt="post">
              </a>
            </div>
            <div class="sigma_post-body">
              <div class="sigma_post-meta">
              ...
              <h5> <a href="blog-details.html">How to abide by Ministries rules without any risks</a> </h5>
              <div class="sigma_post-single-author">
                <img src="/themes/frontend/assets/img/people/2.jpg" alt="author">
                <div class="sigma_post-single-author-content">
                  By <p>Aime Bill</p>
                </div>
              </div>
        ...
        <div class="col-lg-4 col-md-6">
          <article class="sigma_post">
            <div class="sigma_post-thumb">
              <a href="blog-details.html">
                <img src="/themes/frontend/assets/img/blog/3.jpg" alt="post">
              </a>
            </div>
            <div class="sigma_post-body">
              <div class="sigma_post-meta">
