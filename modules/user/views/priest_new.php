								...
								<div data-simplebar class="nicescroll-bar">
									...
									<div class="contact-list-view">
										<table id="datable_1" class="table nowrap w-100 mb-5">
											...
											<tbody>
                                            <?php  {?>
                                                <?php foreach ($priests as $key => $value) {  ?>  
                                                    <tr>
                                                        <td>
                                                            <!-- <div class="d-flex align-items-center">
                                                        ...
                                                        <td><?php echo $value['pr_father_name'] ?></td>
                                                        <td><?php echo $value['pr_mother_name'] ?></td>
                                                        <td><?php echo $value['pr_birth_date'] ?></td>
                                                        <td><?php echo $value['pr_birth_place'] ?></td>
                                                        <td><?php echo $value['email'] ?></td>
                                                        <td><?php echo $value['mobile'] ?></td>
                                                        <td><?php echo $value['pr_parish'] ?></td>
                                                        <td><?php echo $value['pr_seminary'] ?></td>
                                                        <td><?php echo $value['pr_type'] ?></td>
                                                        <td><?php echo $value['level'] ?></td>
                                                        <td><?php echo $value['pr_ordination_date'] ?></td>
                                                        <td><?php echo "Ordination place" ?></td>
                                                        <td><?php echo $value['pr_ordination_by'] ?></td>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="d-flex">
							...
							<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
								<div class="modal-content">
									<div class="modal-body">
										...
										<h5 class="mb-5">Create New Priest</h5>
										<form>
											<div class="row gx-3">
                                            ...
                                            <div class="col-sm-12 form-group">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control mnh-100p" rows="4" ></textarea>
                                                </div>
                                            </div>
											
											<div class="title title-xs title-wth-divider text-primary text-uppercase my-4"><span>Official Info</span></div>
											<div class="row gx-3">
												<div class="col-sm-6">
													<div class="form-group">
												...
												<div class="col-sm-6">
													<div class="form-group">
														<label class="form-label">Seminary</label>
														<input class="form-control" type="text"/>
													</div>
												</div>
                                                <div class="col-sm-6">
													<div class="form-group">
														<label class="form-label">Priest Type</label>
														<select class="form-select">
															<option selected="">Select Priest Type</option>
															<option value="1">Diocesan Priests</option>
															<option value="2">Priests on Contract</option>
															<option value="3">Religious Priests</option>
															<option value="3">Religious Men</option>
															<option value="3">Other Diocesan Priests</option>
														</select>
													</div>
												</div>
                                                <div class="col-sm-6">
													<div class="form-group">
														<label class="form-label">Priest Level</label>
														<select class="form-select">
												...
												<div class="col-sm-6">
													<div class="form-group">
														<label class="form-label">Ordination Place</label>
														<input class="form-control" type="text"/>
													</div>
												</div>
                                                <div class="col-sm-6">
													<div class="form-group">
														<label class="form-label">Ordination By</label>
														<input class="form-control" type="text"/>
													</div>
												</div>
                                                <div class="col-sm-6">
