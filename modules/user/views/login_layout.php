...
<!-- Mirrored from hencework.com/theme/jampack/classic/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Feb 2024 09:49:45 GMT -->
<head>
    <!-- Meta Tags -->
	<meta charset="UTF-8">
				...
				<div class="container-fluid">
					...
					<div class="row auth-split">
							...
							<div class="auth-content flex-column pt-8 pb-md-8 pb-13">
								<div class="text-center mb-7">
									<a class="navbar-brand me-0" href="<?php echo base_url()?>">
										<img class="brand-img d-inline-block" src="<?php echo base_url('themes/default/images/logo.png?1234'); ?>" alt="brand">
									</a>
								</div>
										...
										<div class="col-xl-7 col-sm-10 mx-auto">
											...
											<div class="row gx-3">
												<div class="form-group col-lg-12">
													...
													<input class="form-control" name="username" value="<?php echo set_value('username'); ?>"  placeholder="Enter username or email ID" type="text">
												</div>
												<div class="form-group col-lg-12">
													<div class="form-label-group">
														<label>Password</label>
														<a href="/themes/admin/#" class="fs-7 fw-medium">Forgot Password ?</a>
													</div>
													<div class="input-group password-check">
														<span class="input-affix-wrapper affix-wth-text">
															<input class="form-control" placeholder="Enter your password" name="password" value="<?php echo set_value('password'); ?>" type="password">
															<a href="/themes/admin/#" class="input-suffix text-primary text-uppercase fs-8 fw-medium">
																<span>Show</span>
                                            ...
                                            <button class="btn btn-primary btn-uppercase btn-block" type="submit">Login</button>
											<p class="p-xs mt-2 text-center">New to Jampack? <a href="/themes/admin/#"><u>Create new account</u></a></p>
											<a href="/themes/admin/#" class="d-block extr-link text-center mt-4"><span class="feather-icon"><i data-feather="external-link"></i></span><u class="text-muted">Send feedback to our help forum</u></a>
										</div>
									</div>
								</form>
							</div>
								...
								<footer class="container-xxl footer">
									<div class="row">
										<div class="col-xl-8 text-center">
											<p class="footer-text pb-0"><span class="copy-text">Jampack © 2023 All rights reserved.</span> <a href="/themes/admin/#" class="" target="_blank">Privacy Policy</a><span class="footer-link-sep">|</span><a href="/themes/admin/#" class="" target="_blank">T&C</a><span class="footer-link-sep">|</span><a href="/themes/admin/#" class="" target="_blank">System Status</a></p>
										</div>
									</div>
								</footer>
							</div>
						...
						<div class="col-xl-7 col-lg-6 col-md-5 col-sm-10 d-md-block d-none position-relative bg-primary-light-5">
							...
							<p class="p-xs credit-text opacity-55">All illustration are powered by <a href="/themes/admin/https://icons8.com/ouch/" target="_blank" class="text-light"><u>Icons8</u></a></p>
						</div>
					</div>
					<!-- /Row -->
				</div>
...
<!-- Mirrored from hencework.com/theme/jampack/classic/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Feb 2024 09:49:46 GMT -->
</html>