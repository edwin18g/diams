  ...
  <section class="banner-two-area">
            <div class="swiper banner-two__slider">
                <div class="swiper-wrapper">
                  ...
                  <?php if(!empty($home_slider)):foreach($home_slider as $c):?>
            ...
            <div class="container">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-4 mb-40">
                    <div class="section-header">
                        <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <i class="fa-regular fa-angles-left pe-1"></i> Parish <i
                                class="fa-regular fa-angles-right ps-1"></i>
                        </h5>
                        <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Our Diocesan Parishes</h2>
                    ...
                    <div class="arry-btn wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                        ...
                        <button class="arry-next cause__arry-next active ml-10"><i class="fa-regular fa-chevron-right"></i></button>
                    </div>
                </div>
            </div>
            <div class="cause__slider-wrp">
                <div class="swiper cause__slider">
                    <div class="swiper-wrapper py-4">                       
                        <?php if(!empty($parish_list)) {foreach ($parish_list as $key => $value) { ?>     
                            <div class="swiper-slide">                       
        ...
        <section class="blog-area pt-60 pb-60  sub-bg">
            <div class="container">
                <div class="section-header mb-60 text-center">
                    <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <i class="fa-regular fa-angles-left pe-1"></i>Articles<i class="fa-regular fa-angles-right ps-1"></i>
                    </h5>
                            ...
                            <div class="testimonial__item m-0 pl-0">
                                <div class="team__item image" >
                                    ...
                                    <div class="team__content">
                                        <div class="content">
                                            <h4><a href="team-single.html" class="primary-hover"><?=$priest['full_name']?></a></h4>
        ...
        <section class="event-area pt-60 pb-60 bg-image" data-background="/themes/frontend/assets/images/bg/event-bg-image.jpg">
        ...
        <section class="project-area pt-60 pb-120">
            <div class="container">
            <div class="section-header text-center mb-60">
                    <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
        ...
        <section class="blog-area pt-60 pb-60  sub-bg">
            <div class="container">
                <div class="section-header mb-60 text-center">
                    <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <i class="fa-regular fa-angles-left pe-1"></i>Watch Now<i class="fa-regular fa-angles-right ps-1"></i>
                    </h5>
                    <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Our Diocesan Youtube</h2>
                </div>
                <div class="row g-8">
                   <div class="col-xl-4 col-md-6 wow fadeInUp video__left-item bg-image h-100"
                        data-background="/themes/frontend/assets/images/video/video-left-image.jpg">
                        <div class="video__btn-wrp">
                            <div class="video-btn video-pulse">
                                <a class="video-popup" href="https://www.youtube.com/watch?v=ElG5-nXD0B8"><i
